(function () {
  ...
  var colorSlugs = ["bej", "lacivert", "antrasit", "saks-mavisi", "turuncu", "siyah", "kirmizi", "bordo", "haki", "beyaz"];
  ...
  window.HERO_PRODUCTS = [
    {
      ...
      colors: tshirtColors,
      code: "KT-TS-040",
      defaultModelCode: "KT-TS-035",
      alternates: [{ code:"KT-TS-037", productName:"Fermuar Cepli Polo İş Tişörtü", description:"Kontrast omuz paneli, biye ve fermuarlı göğüs cebiyle teknik ekipler için hazırlanan polo iş tişörtü.", imageAlt:"KT-TS-037 fermuar cepli polo iş tişörtü", colors:tshirtAltColors, fabric:"40/1 Full Likralı Lakost", weight:"170–180 g/m²", composition:"%94 pamuk, %6 lycra", useArea:"Servis, bakım ve saha ekipleri", logoOptions:"Nakış, serigrafi ve transfer baskı", minimumOrder:"50 adet", wash:"30 °C hassas yıkama; tersten yıkayın." }, { code:"KT-TS-035", productName:"Fermuarlı Cepli Teknik Polo Tişört", description:"Petrol mavisi gövde, kontrast paneller ve fermuarlı göğüs cebiyle teknik polo model.", imageAlt:"KT-TS-035 teknik polo tişört", colors:tshirtLegacyColors, fabric:"40/1 Full Likralı Lakost", weight:"170–180 g/m²", composition:"%94 pamuk, %6 lycra", useArea:"Servis, bakım ve saha ekipleri", logoOptions:"Nakış, serigrafi ve transfer baskı", minimumOrder:"50 adet", wash:"30 °C hassas yıkama; tersten yıkayın." }, { code:"KT-TS-036", productName:"Fosfor Garnili Bisiklet Yaka İş Tişörtü", description:"Fosfor omuz ve yan panellerle görünürlüğü destekleyen iş tişörtü.", imageAlt:"KT-TS-036 fosfor garnili iş tişörtü", colors:tshirtLegacyAltColors, fabric:"30/1 Compact Pike", weight:"190–200 g/m²", composition:"%100 pamuk" }],
      productName: "V Yaka Teknik İş Tişörtü",
      fabric: "30/1 Compact Pike",
      weight: "190–200 g/m²",
    ...
    },
    {
      ...
      code: "KT-SW-034",
      alternates: [{ code:"KT-SW-036", productName:"Cepli Polo Sweatshirt", description:"Kontrast panelleri ve işlevsel göğüs cebiyle kurumsal ekip kullanımı için hazırlanan polo sweatshirt.", imageAlt:"KT-SW-036 cepli polo sweatshirt", colors:sweatAltColors, fabric:"Üç iplik sweatshirt kumaşı", weight:"310–330 g/m²", composition:"%65 pamuk, %35 polyester", useArea:"Bakım, üretim ve teknik servis ekipleri", logoOptions:"Nakış, serigrafi ve transfer baskı", minimumOrder:"50 adet", wash:"30 °C tersten yıkama; düşük ısıda ütüleyin." }, { code:"KT-SW-016", productName:"Reflektörlü Polo Yaka Sweatshirt", description:"Reflektif bantlarıyla kurumsal saha ekiplerine uygun sweatshirt.", imageAlt:"KT-SW-016 reflektörlü sweatshirt", colors:sweatLegacyColors }, { code:"KT-SW-028", productName:"Yarım Fermuarlı Teknik Sweatshirt", description:"Turuncu biyeler ve takviyelerle hazırlanan teknik sweatshirt.", imageAlt:"KT-SW-028 teknik sweatshirt", colors:sweatLegacyAltColors, fabric:"Üç iplik sweatshirt kumaşı" }],
