(function () {
  ...
  function initProductShowcase() {
    ...
    function renderColors(product) {
      ...
      product.colors.forEach(function (color, index) {
        ...
        button.addEventListener("click", function () {
          ...
          stage.style.setProperty("--selected-product-color", color.value);
          if (color.image) {
            stage.classList.add("is-changing");
            window.setTimeout(function () {
              image.src = color.image;
              image.alt = product.productName + " - " + color.name;
              status.hidden = true;
    ...
    function applyProduct(index, animate) {
      ...
      function update() {
        stage.setAttribute("data-product-id", product.id);
        image.src = (product.colors[0] && product.colors[0].image) || product.image;
        ...
        stage.style.setProperty("--selected-product-color", product.colors[0].value);
