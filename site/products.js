...
window.KATALOG = [
  ...
  /* ---------------- MONT & KABAN ---------------- */
  {
    ...
    unit: "model",
    urunler: [
      { img: "../../hero/montkaban/kt-mk-001-lacivert.webp", keepFormat: true, code: "KT-MK-001", name: "Reflektörlü Teknik İş Montu", tags: "Lacivert | Reflektörlü | Teknik mont | Fermuarlı cepler | Açık saha", description: "Reflektif detayları ve koruyucu yapısıyla açık saha, sevkiyat ve teknik ekipler için hazırlanan iş montu." },
