...
window.KATALOG = [
  ...
  /* ---------------- ÖNLÜK ---------------- */
  {
    ...
    urunler: [
      ...
      { img: "kt-on-040-adacayi-kruvaze-scrub-takim.webp", code: "KT-ON-040", name: "Adaçayı Yeşili Kruvaze Scrub Takım", tags: "Scrub takım | Adaçayı yeşili | Kruvaze yaka | Kısa kol | İki alt cep | Düz paça pantolon", description: "Adaçayı yeşili kruvaze üstü ve düz paça pantolonuyla sağlık, güzellik ve danışmanlık ekiplerine çağdaş bir kurumsal görünüm sunan iki parçalı scrub takımdır." },
