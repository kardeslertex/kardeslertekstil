...
window.KATALOG = [
  ...
  /* ---------------- MONT & KABAN ---------------- */
  {
    ...
    urunler: [
      ...
      { img: "04.jpg", name: "Saks Mavi Reflektörlü İş Montu", tags: "Saks mavi | Siyah yaka, yan panel ve kol detayı | Göğüste reflektif şerit | Çift kapaklı göğüs cep | Fermuarlı yan cepler | İş montu" },
      { img: "08.jpg", name: "Siyah Gri Enine Kesimli Şişme Mont", tags: "Siyah | Gri V kesim gövde paneli | Enine ray dikişli şişme yapı | Çıtçıt kapamalı ön pat | Yan cepler | Kışlık mont" },
